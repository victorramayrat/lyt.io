      ...
      <div>
        ...
        <main className={mainContent}>
          <div className={justifyCenter}>
            ...
            <p className={textCore}> In a world where timing is everything, we value what you see. Capture up to 60 seconds of real-time, newsworthy footage, upload it to Lyt, and get discovered. Then share and monetize your digital assets using the <strong>Lyteum Licensing ĐApp</strong>.</p>
